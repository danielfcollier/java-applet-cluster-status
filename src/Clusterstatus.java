...
/**
 * Usada para implementar o frame clusterstatus.
 *
 * Implementa os métodos  de controle do frame.
 *
...
public class Clusterstatus extends JFrame implements ItemListener {
// ------------------------------------------------------------------
...
// ------------------------------------------------------------------
    /**
     * Trata o evento de mouse. A chamada a função NodeClicked determina sobre qual nó ocorreu
     * o evento e trata a ação específica para a região em que ocorreu o evento ( seleção ou expansão ). 
     *
     */     
...
// ------------------------------------------------------------------
    ...
    public static void main( String args[] ) {
        Clusterstatus application = new Clusterstatus();
